...
import edu.cnm.deepdive.quoteclient.view.ContentsRecyclerAdapter;
...
public class ContentFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    viewModel.getContents().observe(getViewLifecycleOwner(), (contents) -> {
      ContentsRecyclerAdapter adapter = new ContentsRecyclerAdapter(getContext(), contents);
      contentList.setAdapter(adapter);
    });
    viewModel.refreshContens();
  }
}